...
<div class="jumbotron text-center">
  <h1>CLICKONOLOGY</h1> 
  <p>We specialize web presence</p> 
  ...
  <div class="row">
    <div class="col-sm-8">
      ...
      <p>At Clickonology.com, we know a website is a great window to your business seen from anywhere in the world. In these days of the Smartphone, access to the internet is available at the touch of a button - and so is your business. Whether it is just a phone number or address required or buying a product at home, work or on the go, let Clickonology increase YOUR presence online and increase YOUR profit at an affordable price.<br>
        ...
        Your website will be fully RESPONSIVE for tailored use on any platform whether it be mobile phone, tablet, laptop, pc, tv screen. This approach also enhances search engine results. Clickonology makes sure you have full control and input in the design, creation and roll out of your own personalised responsive website.<br>
        
        There are many services online offering FREE webpage templates for you to create you own website. What you get is what you pay for. Bloated code on these FREE pages can smokescreen your content from the newest search engine techniques. Quite often, inserted pictures and videos can do nothing to help your website. They might look good but your audience will be limited by lack of exposure.<br>
        
        All webpages created by Clickonology are HAND CRAFTED! Each page has it's uniquely placed clean code to encourage the search engines to promote your content. Your webpages will be enhanced with minimal code and fuller content to drive your pages to a much higher ranking in other people's searches.<br>
        
        You don't need a fancy website full of bling which is not the answer but a website that just works and works well for YOU!</p>
  ...
  <div class="row">
    ...
    <div class="col-sm-8">
      ...
      <p><strong>VISION:</strong> 
        Owner has been computer programming since 1982 and in the web design field since 1999. Progression of the internet has brought the world a lot closer than ever before. Now, with the aid of Smartphones, the other side of the globe is in the palm of your hand.<br>

        Many web design companies exist. They charge extortionate fees for websites that are unnecessarily complex but can make your eyes pop out! Full of razmataz, glitz and pop-ups. The real content is hidden, bland and (in some cases) hard to find what you are looking for. HTML, CSS, Javascript, PHP. . . who cares? You don't, we do. What matters to you is the result!<br>
